  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-zinc-600">Shortcut ke fitur utama (login: <span className="font-medium">{user.email}</span>).</p>
      </div>
      ...
      <div className="rounded-xl border bg-white p-5 shadow-sm">
        ...
        <ol className="mt-3 list-decimal space-y-2 pl-5 text-sm text-zinc-700">
          <li>Create a <Link href="/templates" className="underline">template</Link> or use the seeded example.</li>
          <li>Create a <Link href="/presets" className="underline">preset</Link> from a template.</li>
          <li>Create a <Link href="/prompts" className="underline">prompt</Link>, edit JSON, and save a version.</li>
          <li>Opsional: gunakan <Link href="/ai-json" className="underline">AI JSON Editor</Link> untuk bantu edit JSON cepat.</li>
          <li>Upload generated images and rate them.</li>
        </ol>
        <p className="mt-3 text-sm text-zinc-600">Images attached: <span className="font-medium">{imageCount}</span></p>
      </div>
    </div>
  );
}
